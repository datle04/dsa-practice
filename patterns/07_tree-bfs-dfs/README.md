...
| # | Problem | Type | Status | Date |
|---|---------|------|--------|------|
| 6 | [Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal/) | BFS | | |
| 7 | [Validate Binary Search Tree](https://leetcode.com/problems/validate-binary-search-tree/) | DFS | | |
| 8 | [Kth Smallest Element in a BST](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) | DFS inorder | | |
